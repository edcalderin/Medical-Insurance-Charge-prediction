...
def main():
    ...
    with col1:
        ...
        medical_history: str = st.selectbox('Medical History', ('Heart disease', 'High blood pressure', 'Diabetes', 'Healthy'))
        occupation: str = st.selectbox('Occupation', ('Unemployed', 'Student', 'Blue collar', 'White collar'))
    with col2:
        gender: str = st.selectbox('Gender', ('male', 'female'))
        smoker: str = st.selectbox('Smoker', ('yes', 'no'))
        family_medical_history: str = st.selectbox('Family Medical History', ('Heart disease', 'High blood pressure', 'Diabetes', 'Healthy'))
    ...
    with col3:
        ...
        exercise_frequency: str = st.selectbox('Exercise Frequency', ('Rarely', 'Occasionally', 'Frequently', 'Never'))
    ...
    if st.button('Calculate charge'):
        with st.spinner():
            customer = {
                ...
                'family_medical_history': None if family_medical_history=='Healthy' else medical_history,
